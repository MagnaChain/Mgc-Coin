...
function Network(options) {
  //console.log("################### BCOIN Network: " + JSON.stringify(options) );
...
Network.create = function create(options) {
  //console.log("################### BCOIN Network.create : " + JSON.stringify(options) );
  let network;
...
Network.get = function get(type) {
  //console.log("################### BCOIN Network.get : " + JSON.stringify(type) );
  if (!type) {
...
Network.set(process.env.BCOIN_NETWORK || 'testnet');
