...
function BufferReader(data, zeroCopy) {
  //console.log("################### BufferReader constructor " );
...
BufferReader.prototype.endData = function endData(zeroCopy) {
  ...
  if (size === data.length)
  {
	//console.log("################### BufferReader read size =  data.length" );
	return data; 
  }
  ...
  {
	//console.log("################### BufferReader read size start to end" );
	return data.slice(start, end);
  }
   
  //console.log("################### BufferReader read size erro,return buf of 0" );
...
BufferReader.prototype.readString = function readString(enc, size) {
  let ret;
  //console.log("################### BufferReader size is :" +  enc );
  assert(size >= 0);
  this.assert(this.offset + size <= this.data.length);
