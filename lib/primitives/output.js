...
Output.prototype.getJSON = function getJSON(network) {
  let addr = this.getAddress();
  console.log("################### Output.prototype.getJSON before: " + network );
  network = Network.get(network);
  console.log("################### Output.prototype.getJSON after: " + network );
  if (addr)
...
Output.prototype.fromReader = function fromReader(br) {
  ...
  //let addr = this.getAddress();
  //console.log("################### Output.prototype.fromReader adress: " + JSON.stringify(addr) );
  let data = this.toJSON();
  console.log("################### Output.prototype.fromReader address: " + JSON.stringify(data.address) );
  return this;
};
